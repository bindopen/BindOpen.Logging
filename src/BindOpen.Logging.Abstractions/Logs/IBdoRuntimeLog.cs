...
namespace BindOpen.Logging
{
    ...
    public interface IBdoRuntimeLog : IBdoLog
    {
        ...
        /// <returns></returns>
        IBdoRuntimeLog WithExecution(IProcessExecution execution);

        /// <summary>
        /// 
        /// </summary>
        IBdoRuntimeLog Sanitize();

        /// <summary>
        /// 
        /// </summary>
        IBdoRuntimeLog Start();

        /// <summary>
        /// 
        /// </summary>
        /// <param name="status"></param>
        IBdoRuntimeLog End(ProcessExecutionStatus status = ProcessExecutionStatus.Completed);
